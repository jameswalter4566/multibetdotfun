...
const HARDCODED_SUPABASE_URL = "https://bqncfjnigubyictxbliq.supabase.co";
const HARDCODED_SUPABASE_ANON_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJxbmNmam5pZ3VieWljdHhibGlxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDYxNjE4NzUsImV4cCI6MjA2MTczNzg3NX0.BF3cKuOnaGJI-SlPKW52lnw6SxiwQtK0eU-ofGGcKrs";

const envSupabaseUrl = (import.meta.env.VITE_SUPABASE_URL as string | undefined)?.trim();
const resolvedSupabaseUrl = (envSupabaseUrl || HARDCODED_SUPABASE_URL).replace(/\/$/, "");
const supabaseAnonKey = (import.meta.env.VITE_SUPABASE_ANON_KEY as string | undefined)?.trim() || HARDCODED_SUPABASE_ANON_KEY;
const SUPABASE_FUNCTION_ENDPOINT = `${resolvedSupabaseUrl}/functions/v1/assistant-chat`;

const DEFAULT_ASSISTANT_ENDPOINT = SUPABASE_FUNCTION_ENDPOINT;
