...
const docHome = apiProviders[0] ? `/documentation/${apiProviders[0].slug}` : "/marketplace";

const sideLinks: { label: string; href: string }[] = [
    ...
    <div className="flex min-h-screen bg-background text-foreground">
      ...
      <div className="flex min-h-screen flex-1 flex-col sm:ml-64">
        ...
        <main className="flex-1 px-4 py-10 sm:px-8 lg:px-12">
          <section id="marketplace" className="max-w-7xl mx-auto">
